...
proc import file="/notebooks/notebooks/titanic_train.csv" 
out=train dbms=csv replace;
run;

proc import file="/notebooks/notebooks/titanic_test.csv" 
...
%register_model('titanic_logistic', 'titanic_classification_1', 'test_sas_model', 'score', 'sas'); 
